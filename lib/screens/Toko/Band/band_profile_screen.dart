...
import 'edit_band_member_screen.dart'; // NUEVO
...
class _BandProfileScreenState extends State<BandProfileScreen> {
  // ... (Controladores y estados se mantienen igual) ...
  ...
  // --- FUNCIÓN UNIFICADA PARA ELIMINAR MIEMBROS ---
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      final updatedData = {
        ...
        'contactEmail': _emailController.text.trim(), 'socialLinks': _socialsController.text.trim(),
  ...
  // --- UI: WIDGET DE GESTIÓN DE MIEMBROS ---
      ...
      child: Column(
        ...
        children: [
          ...
          ...tokouserMembers.entries.map((entry) {
            ...
            final memberName = "Usuario Toko ($memberUid)"; // Usamos UID como nombre por ahora
            ...
            return ListTile(
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (value) async {
                  if (value == 'edit') {
                    // Navegar al editor de rol para usuario Toko
                    // Necesitas el memberData del usuario Toko, que requiere una consulta extra a 'users'
                ...
                children: externalMembers.map((doc) {
                  ...
                  return ListTile(
                    ...
                    trailing: PopupMenuButton<String>(
                      ...
                      onSelected: (value) async {
                        if (value == 'edit') {
                          // Navegar al editor de miembro externo
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => EditBandMemberScreen(
                                bandId: widget.bandId, memberId: doc.id, memberData: data, isExternalMember: true,
                              ),
                            ),
                          );
                        } else if (value == 'delete') {
